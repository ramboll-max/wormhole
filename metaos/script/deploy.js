...
async function instantiate(contract, inst_msg) {
  ...
  console.log(
    `Instantiated ${contract} at ${contractAddress} (${convert_metaos_address_to_hex(
        contractAddress
    )})`
  );
...
// MetaOS addresses are "human-readable", but for cross-chain registrations, we
// want the "canonical" version
function convert_metaos_address_to_hex(human_addr) {
